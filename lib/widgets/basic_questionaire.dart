...
class BasicQuestionaire extends StatefulWidget {
  ...
  @override
  State<BasicQuestionaire> createState() =>
      _BasicQuestionaireState();
}

class _BasicQuestionaireState extends State<BasicQuestionaire> {
  int _index = 0;
